...
// Provider GUID = 4ccaa233-6675-4ec5-b3a6-1aa68b7c8ae9
...
#ifndef MicrosoftServiceBus_Traits
#define MicrosoftServiceBus_Traits NULL
#endif // MicrosoftServiceBus_Traits
...
EXTERN_C __declspec(selectany) const unsigned char Microsoft_ServiceBusLevels[4] = {4, 2, 4, 2};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT MicrosoftServiceBus_Context = {0, (ULONG_PTR)MicrosoftServiceBus_Traits, 0, 0, 0, 0, 0, 0, 4, Microsoft_ServiceBusEnableBits, Microsoft_ServiceBusKeywords, Microsoft_ServiceBusLevels};

//
// Provider REGHANDLE
//
#define Microsoft_ServiceBusHandle (MicrosoftServiceBus_Context.RegistrationHandle)
...
//
#define MicrosoftServiceBus_EventWriteActivity 0
...
//
#ifndef EventRegisterByGuidMicrosoft_ServiceBus
#define EventRegisterByGuidMicrosoft_ServiceBus(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &MicrosoftServiceBus_Context, &Microsoft_ServiceBusHandle)
#endif
...
//
#define EventEnabledLogInfoEvent() MCGEN_EVENT_BIT_SET(Microsoft_ServiceBusEnableBits, 0)

//
// Event write macros for LogInfoEvent
//
#define EventWriteLogInfoEvent(content) \
        MCGEN_EVENT_ENABLED(LogInfoEvent) \
        ? McTemplateU0s(&MicrosoftServiceBus_Context, &LogInfoEvent, content) : 0
#define EventWriteLogInfoEvent_AssumeEnabled(content) \
        McTemplateU0s(&MicrosoftServiceBus_Context, &LogInfoEvent, content)

//
// Enablement check macro for LogErrorEvent
//
#define EventEnabledLogErrorEvent() MCGEN_EVENT_BIT_SET(Microsoft_ServiceBusEnableBits, 1)

//
// Event write macros for LogErrorEvent
//
#define EventWriteLogErrorEvent(content, file, time, function, line) \
        MCGEN_EVENT_ENABLED(LogErrorEvent) \
        ? McTemplateU0ssysq(&MicrosoftServiceBus_Context, &LogErrorEvent, content, file, time, function, line) : 0
#define EventWriteLogErrorEvent_AssumeEnabled(content, file, time, function, line) \
        McTemplateU0ssysq(&MicrosoftServiceBus_Context, &LogErrorEvent, content, file, time, function, line)

//
// Enablement check macro for LogDebugEvent
//
#define EventEnabledLogDebugEvent() MCGEN_EVENT_BIT_SET(Microsoft_ServiceBusEnableBits, 2)

//
// Event write macros for LogDebugEvent
//
#define EventWriteLogDebugEvent(content, file, time, function, line) \
        MCGEN_EVENT_ENABLED(LogDebugEvent) \
        ? McTemplateU0ssysq(&MicrosoftServiceBus_Context, &LogDebugEvent, content, file, time, function, line) : 0
#define EventWriteLogDebugEvent_AssumeEnabled(content, file, time, function, line) \
        McTemplateU0ssysq(&MicrosoftServiceBus_Context, &LogDebugEvent, content, file, time, function, line)

//
// Enablement check macro for LogLastError
//
#define EventEnabledLogLastError() MCGEN_EVENT_BIT_SET(Microsoft_ServiceBusEnableBits, 3)

//
// Event write macros for LogLastError
//
#define EventWriteLogLastError(content, file, time, function, line, getLastError) \
        MCGEN_EVENT_ENABLED(LogLastError) \
        ? McTemplateU0ssysqs(&MicrosoftServiceBus_Context, &LogLastError, content, file, time, function, line, getLastError) : 0
#define EventWriteLogLastError_AssumeEnabled(content, file, time, function, line, getLastError) \
        McTemplateU0ssysqs(&MicrosoftServiceBus_Context, &LogLastError, content, file, time, function, line, getLastError)
...
//
#ifndef McTemplateU0ssysq_def
#define McTemplateU0ssysq_def
ETW_INLINE
ULONG
McTemplateU0ssysq(
    _In_ PMCGEN_TRACE_CONTEXT Context,
...
{
#define McTemplateU0ssysq_ARGCOUNT 5

    EVENT_DATA_DESCRIPTOR EventData[McTemplateU0ssysq_ARGCOUNT + 1];
    ...
    EventDataDescCreate(&EventData[3],_Arg2, sizeof(SYSTEMTIME)  );
    ...
    return McGenEventWrite(Context, Descriptor, NULL, McTemplateU0ssysq_ARGCOUNT + 1, EventData);
}
#endif // McTemplateU0ssysq_def

//
//Template from manifest : _template_log_last_error
//
#ifndef McTemplateU0ssysqs_def
#define McTemplateU0ssysqs_def
ETW_INLINE
ULONG
McTemplateU0ssysqs(
    _In_ PMCGEN_TRACE_CONTEXT Context,
...
{
#define McTemplateU0ssysqs_ARGCOUNT 6

    EVENT_DATA_DESCRIPTOR EventData[McTemplateU0ssysqs_ARGCOUNT + 1];
    ...
    return McGenEventWrite(Context, Descriptor, NULL, McTemplateU0ssysqs_ARGCOUNT + 1, EventData);
}
#endif // McTemplateU0ssysqs_def
